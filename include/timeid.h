...
_CRC(0),_UpdateMe(0),_DataBaseSize(0),_pDataBaseEntries(0){}
...
_UpdateMe(0),_DataBaseSize(0),_pDataBaseEntries(0){_CalcCRC();}
AMSTimeID( AMSID  id, tm  begin, tm end, integer nbytes,  void *pdata);
~AMSTimeID(){delete[] _pDataBaseEntries;_pDataBaseEntries=0;}
