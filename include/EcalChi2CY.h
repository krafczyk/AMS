...
public:
    ...
    */
    float get_mean(int flayer, float coo, float Erg, int type,double& grad)    ;
    ...
    */
    float get_rms (int flayer, float coo, float Erg, int type,double& grad)    ;
    ///Get hit occupance
    /*!
    \param[in] flayer   Layer number. e.g 0~17
    \param[in] coo      Coordinate w.r.t the shower axis
    ...
    */
    float get_prob(int flayer, float coo, float Erg, int type,double& grad)    ;
...
public:
    ...
    */
    ...
    \param[in] iTrTrackPar   Tracker Track iTrTrackPar
    ret chi2      if successful, return average of all hits' chi2; else if iTrTrackPar<0, return -1
    */
    ...
    ret chi2 if successful, return average of all hits' chi2
    */
    ...
    */
    ...
    ///Get average of  xz projection's cells' chi2
    /*!
    ret chi2x  The average of all hits' chi2. sum_{hit i(belong to xz plane,ie layer 2,3 ...)}(chi2_i)/Nhits
    */
    float   get_chi2x() {return _chi2x;}
    ///Get average of  xz projection's cells' chi2
    /*!
    ret chi2y  The average of all hits' chi2. sum_{hit i(belong to yz plane,ie layer 0,1 ...)}(chi2_i)/Nhits
    */
