//  $Id: root.h,v 1.538 2013/02/20 18:14:17 cconsola Exp $
//
//  NB
...
input   
          ...
          Amass     atomic mass number  (0: for electrons and positrons  :1 for p anti-p 4: He ...)
output
          gal_long   Galctic longigude (deg)
          gal_lat    Galctic latitude  (deg)
 ...
 \return 0 secondary particle (unercutoff i.e. particle is likely of atmoepheric origin) ;
