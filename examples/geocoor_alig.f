         SUBROUTINE GEOCOOR_alig
     +    (glat,glong,galtt,cutoff,blat,cm_min,cm_max)
...
c         write(*,*)cl,cl1
         ...
         cth=sin(60./180*3.1416926);
         cm_min=59.2*(re/distd)**2*cl**4/(1+sqrt(1+cth*cl**3))**2	 
         cm_max=59.2*(re/distd)**2*cl**4/(1+sqrt(1-cth*cl**3))**2	 
	 blat=-(pi2-xl)
  	return
        end        
