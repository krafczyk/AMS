//  $Id: xform_proc_3x3.h,v 1.3 2001/01/22 17:32:54 choutko Exp $
...
#define X_headl 50
#define X_clock 80
#define N_comp  8 /*number of computers */
...
int Xf_init(void) {
 ...
 /*HeaD OF form */
  ...
  add_stat_box(695,Y_current,340,250,"statistics");
  Y_current +=170;
  check_[1][N_comp]= add_check_field(1,N_comp,120,Y_current+25,320,40,"DB disk used");
