...
int Coordinates(matr3 Coo_M1950, matr3 Vel_M1950, double q[4], time_t utime, polar *Ge, double *V_a, Euler *E_LVLH, polar *Sol, double *Green_Phi) {
  ...
  *V_a=Vel_angle;
  ...
  Greenw_Phi *= -1.; /* Greenwich GTOD --> in I2000 */

  *Green_Phi = Greenw_Phi;

  /*=========== ANGLES CALCULATION ===========*/
  /* body axis ----> M1950 */
  Ebody_1950[0][0]=q[0]*q[0]+q[1]*q[1]-q[2]*q[2]-q[3]*q[3];
  Ebody_1950[1][1]=q[0]*q[0]-q[1]*q[1]+q[2]*q[2]-q[3]*q[3];
  Ebody_1950[2][2]=q[0]*q[0]-q[1]*q[1]-q[2]*q[2]+q[3]*q[3];
  Ebody_1950[0][1]=2*(q[1]*q[2]-q[0]*q[3]);
  Ebody_1950[1][0]=2*(q[1]*q[2]+q[0]*q[3]);
  Ebody_1950[0][2]=2*(q[1]*q[3]+q[0]*q[2]);
  Ebody_1950[2][0]=2*(q[1]*q[3]-q[0]*q[2]);
  Ebody_1950[1][2]=2*(q[2]*q[3]-q[0]*q[1]);
  Ebody_1950[2][1]=2*(q[2]*q[3]+q[0]*q[1]);
