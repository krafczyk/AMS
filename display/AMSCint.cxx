...
extern "C" void G__set_cpp_environmentAMSCint() {
  ...
  G__add_compiledheader("AMSColorManager.h");
...
/* AMSColorManager */
static int G__AMSColorManager_AMSColorManager_0_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   AMSColorManager *p;
   switch(libp->paran) {
   case 2:
      p = new AMSColorManager((char*)G__int(libp->para[0]),(char*)G__int(libp->para[1]));
      break;
   case 1:
      p = new AMSColorManager((char*)G__int(libp->para[0]));
      break;
   case 0:
   if(G__getaryconstruct()) p=new AMSColorManager[G__getaryconstruct()];
   else                    p=new AMSColorManager;
      break;
   }
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager);
   return(1);
}

static int G__AMSColorManager_GetColorAt_2_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSColorManager*)(G__getstructoffset()))->GetColorAt((Int_t)G__int(libp->para[0]),(Float_t*)G__int(libp->para[1])
,(Float_t*)G__int(libp->para[2]),(Float_t*)G__int(libp->para[3])));
   return(1);
}

static int G__AMSColorManager_IsValid_3_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,98,(long)((AMSColorManager*)(G__getstructoffset()))->IsValid((Int_t)G__int(libp->para[0])));
   return(1);
}

static int G__AMSColorManager_Migrate_4_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSColorManager*)(G__getstructoffset()))->Migrate((Int_t)G__int(libp->para[0]),(Int_t)G__int(libp->para[1])));
   return(1);
}

static int G__AMSColorManager_ColorTest_5_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 2:
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->ColorTest((Int_t)G__int(libp->para[0]),(Int_t)G__int(libp->para[1]));
      break;
   case 1:
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->ColorTest((Int_t)G__int(libp->para[0]));
      break;
   case 0:
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->ColorTest();
      break;
   }
   return(1);
}

static int G__AMSColorManager_DeclFileName_6_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMSColorManager*)(G__getstructoffset()))->DeclFileName());
   return(1);
}

static int G__AMSColorManager_DeclFileLine_7_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSColorManager*)(G__getstructoffset()))->DeclFileLine());
   return(1);
}

static int G__AMSColorManager_ImplFileName_8_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMSColorManager*)(G__getstructoffset()))->ImplFileName());
   return(1);
}

static int G__AMSColorManager_ImplFileLine_9_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSColorManager*)(G__getstructoffset()))->ImplFileLine());
   return(1);
}

static int G__AMSColorManager_Class_Version_0_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((AMSColorManager*)(G__getstructoffset()))->Class_Version());
   return(1);
}

static int G__AMSColorManager_Class_1_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSColorManager*)(G__getstructoffset()))->Class());
   return(1);
}

static int G__AMSColorManager_Dictionary_2_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->Dictionary();
   return(1);
}

static int G__AMSColorManager_IsA_3_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSColorManager*)(G__getstructoffset()))->IsA());
   return(1);
}

static int G__AMSColorManager_ShowMembers_4_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1);
}

static int G__AMSColorManager_Streamer_5_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSColorManager*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1);
}

// automatic copy constructor
static int G__AMSColorManager_AMSColorManager_6_1(G__value *result7,char *funcname,struct G__param *libp,int hash)
{
   AMSColorManager *p;
   if(1!=libp->paran) ;
   p=new AMSColorManager(*(AMSColorManager*)G__int(libp->para[0]));
   result7->obj.i = (long)p;
   result7->ref = (long)p;
   result7->type = 'u';
   result7->tagnum = G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager);
...
// automatic destructor
static int G__AMSColorManager_wAAMSColorManager_7_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
       delete[] (AMSColorManager *)(G__getstructoffset());
     else
       for(int i=G__getaryconstruct()-1;i>=0;i--)
         ((AMSColorManager *)((G__getstructoffset())+sizeof(AMSColorManager)*i))->~AMSColorManager();
   else if(G__PVOID==G__getgvp()) delete (AMSColorManager *)(G__getstructoffset());
   else ((AMSColorManager *)(G__getstructoffset()))->~AMSColorManager();
   return(1);
}
...
static int G__AMSDisplay_DrawView_5_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   switch(libp->paran) {
   case 2:
      G__setnull(result7);
...
static int G__AMSDisplay_DrawViewGL_6_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSDisplay*)(G__getstructoffset()))->DrawViewGL();
   return(1);
}

static int G__AMSDisplay_DrawViewX3D_7_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSDisplay*)(G__getstructoffset()))->DrawViewX3D();
   return(1);
}

static int G__AMSDisplay_ExecuteEvent_8_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__AMSDisplay_GetEvent_9_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSDisplay*)(G__getstructoffset()))->GetEvent((Int_t)G__int(libp->para[0]));
   return(1);
}

static int G__AMSDisplay_Pad_0_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->Pad());
   return(1);
}

static int G__AMSDisplay_GetCanvas_1_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->GetCanvas());
   return(1);
}

static int G__AMSDisplay_GetObjInfoPad_2_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->GetObjInfoPad());
   return(1);
}

static int G__AMSDisplay_GetEventInfoPad_3_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->GetEventInfoPad());
   return(1);
}

static int G__AMSDisplay_GetTitlePad_4_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->GetTitlePad());
   return(1);
}

static int G__AMSDisplay_GetColorManager_5_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSDisplay*)(G__getstructoffset()))->GetColorManager());
   return(1);
}
...
static int G__AMS3DCluster_Paint_8_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->Paint((Option_t*)G__int(libp->para[0]));
   return(1);
}

static int G__AMS3DCluster_PaintShape_9_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->PaintShape((X3DBuffer*)G__int(libp->para[0]));
   return(1);
}

static int G__AMS3DCluster_DistancetoPrimitive_0_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
...
static int G__AMS3DCluster_SetPoints_1_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->SetPoints((Float_t*)G__int(libp->para[0]));
   return(1);
}

static int G__AMS3DCluster_SetPosition_2_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__AMS3DCluster_SetSize_3_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__AMS3DCluster_SetDirection_4_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->SetDirection((Float_t)G__double(libp->para[0]),(Float_t)G__double(libp->para[1]));
   return(1);
}

static int G__AMS3DCluster_Sizeof3D_5_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->Sizeof3D();
   return(1);
}

static int G__AMS3DCluster_DeclFileName_6_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMS3DCluster*)(G__getstructoffset()))->DeclFileName());
   return(1);
}

static int G__AMS3DCluster_DeclFileLine_7_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMS3DCluster*)(G__getstructoffset()))->DeclFileLine());
   return(1);
}

static int G__AMS3DCluster_ImplFileName_8_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMS3DCluster*)(G__getstructoffset()))->ImplFileName());
   return(1);
}

static int G__AMS3DCluster_ImplFileLine_9_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMS3DCluster*)(G__getstructoffset()))->ImplFileLine());
   return(1);
}

static int G__AMS3DCluster_Class_Version_0_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((AMS3DCluster*)(G__getstructoffset()))->Class_Version());
   return(1);
}

static int G__AMS3DCluster_Class_1_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMS3DCluster*)(G__getstructoffset()))->Class());
   return(1);
}

static int G__AMS3DCluster_Dictionary_2_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->Dictionary();
   return(1);
}

static int G__AMS3DCluster_IsA_3_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMS3DCluster*)(G__getstructoffset()))->IsA());
   return(1);
}

static int G__AMS3DCluster_ShowMembers_4_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMS3DCluster*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1);
}

static int G__AMS3DCluster_Streamer_5_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
// automatic copy constructor
static int G__AMS3DCluster_AMS3DCluster_6_2(G__value *result7,char *funcname,struct G__param *libp,int hash)
{
   AMS3DCluster *p;
   if(1!=libp->paran) ;
...
// automatic destructor
static int G__AMS3DCluster_wAAMS3DCluster_7_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
/* AMSCanvas */
static int G__AMSCanvas_AMSCanvas_1_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   AMSCanvas *p;
...
static int G__AMSCanvas_Update_4_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSCanvas*)(G__getstructoffset()))->Update();
   return(1);
}

static int G__AMSCanvas_EditorBar_5_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSCanvas*)(G__getstructoffset()))->EditorBar();
   return(1);
}

static int G__AMSCanvas_HandleInput_6_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__AMSCanvas_SaveCB_7_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSCanvas*)(G__getstructoffset()))->SaveCB((Widget)G__int(libp->para[0]),(XtPointer)G__int(libp->para[1])
,(XtPointer)G__int(libp->para[2]));
   return(1);
}

static int G__AMSCanvas_DeclFileName_8_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMSCanvas*)(G__getstructoffset()))->DeclFileName());
   return(1);
}

static int G__AMSCanvas_DeclFileLine_9_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSCanvas*)(G__getstructoffset()))->DeclFileLine());
   return(1);
}

static int G__AMSCanvas_ImplFileName_0_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((AMSCanvas*)(G__getstructoffset()))->ImplFileName());
   return(1);
}

static int G__AMSCanvas_ImplFileLine_1_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((AMSCanvas*)(G__getstructoffset()))->ImplFileLine());
   return(1);
}

static int G__AMSCanvas_Class_Version_2_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((AMSCanvas*)(G__getstructoffset()))->Class_Version());
   return(1);
}

static int G__AMSCanvas_Class_3_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSCanvas*)(G__getstructoffset()))->Class());
   return(1);
}

static int G__AMSCanvas_Dictionary_4_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSCanvas*)(G__getstructoffset()))->Dictionary();
   return(1);
}

static int G__AMSCanvas_IsA_5_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((AMSCanvas*)(G__getstructoffset()))->IsA());
   return(1);
}

static int G__AMSCanvas_ShowMembers_6_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((AMSCanvas*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1);
}

static int G__AMSCanvas_Streamer_7_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
// automatic copy constructor
static int G__AMSCanvas_AMSCanvas_8_1(G__value *result7,char *funcname,struct G__param *libp,int hash)
{
   AMSCanvas *p;
   if(1!=libp->paran) ;
...
// automatic destructor
static int G__AMSCanvas_wAAMSCanvas_9_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
extern "C" void G__cpp_setup_inheritanceAMSCint() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager))) {
     AMSColorManager *G__Lderived;
     G__Lderived=(AMSColorManager*)0x1000;
     {
       TNamed *G__Lpbase=(TNamed*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),G__get_linked_tagnum(&G__AMSCintLN_TNamed),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),G__get_linked_tagnum(&G__AMSCintLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
...
static void G__setup_memvarTSwitch(void) {
   ...
   /* AMSColorManager */
static void G__setup_memvarAMSColorManager(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager));
   { AMSColorManager *p; p=(AMSColorManager*)0x1000;
   G__memvar_setup((void*)NULL,102,0,0,-1,G__defined_typename("Float_t"),-1,2,"red[256]=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,102,0,0,-1,G__defined_typename("Float_t"),-1,2,"green[256]=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,102,0,0,-1,G__defined_typename("Float_t"),-1,2,"blue[256]=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarAMSDisplay(void) {
   ...
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),-1,-1,4,"m_ColorManager=",0,"Pointer to the color manager");
   ...
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__AMSCintLN_TPad),-1,-1,4,"m_Buttons=",0,"Pointer to the buttons pad");
...
static void G__setup_memvarAMSCanvas(void) {
   ...
   G__memvar_setup((void*)NULL,117,0,0,G__get_linked_tagnum(&G__AMSCintLN_MenuDesc_t),-1,-2,4,"fgAMSFilePane[-2147483648]=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncAMSColorManager(void) {
   /* AMSColorManager */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager));
   G__memfunc_setup("AMSColorManager",1435,G__AMSColorManager_AMSColorManager_0_0,105,G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),-1,0,2,1,1,0,
"C - - 0 \"AMSColorManager\" name C - - 0 \"AMS Event Display Color Manager\" title",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetColorAt",980,G__AMSColorManager_GetColorAt_2_0,105,-1,G__defined_typename("Int_t"),0,4,1,1,0,
"i - 'Int_t' 0 - i F - 'Float_t' 0 - r "
"F - 'Float_t' 0 - g F - 'Float_t' 0 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsValid",684,G__AMSColorManager_IsValid_3_0,98,-1,G__defined_typename("Bool_t"),0,1,1,1,0,"i - 'Int_t' 0 - i",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Migrate",713,G__AMSColorManager_Migrate_4_0,105,-1,G__defined_typename("Int_t"),0,2,1,1,0,
"i - 'Int_t' 0 - src i - 'Int_t' 0 - dest",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ColorTest",927,G__AMSColorManager_ColorTest_5_0,121,-1,-1,0,2,1,1,0,
"i - 'Int_t' 0 0 begin i - 'Int_t' 0 MaxColor-1 end",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__AMSColorManager_DeclFileName_6_0,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__AMSColorManager_DeclFileLine_7_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__AMSColorManager_ImplFileName_8_0,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__AMSColorManager_ImplFileLine_9_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__AMSColorManager_Class_Version_0_1,115,-1,G__defined_typename("Version_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__AMSColorManager_Class_1_1,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__AMSColorManager_Dictionary_2_1,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__AMSColorManager_IsA_3_1,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__AMSColorManager_ShowMembers_4_1,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__AMSColorManager_Streamer_5_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   // automatic copy constructor
   G__memfunc_setup("AMSColorManager",1435,G__AMSColorManager_AMSColorManager_6_1,(int)('i'),G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),-1,0,1,1,1,0,"u 'AMSColorManager' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~AMSColorManager",1561,G__AMSColorManager_wAAMSColorManager_7_1,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__tag_memfunc_reset();
}
...
"i - 'Int_t' 0 - px i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("DrawView",809,G__AMSDisplay_DrawView_5_1,121,-1,-1,0,2,1,1,0,
"f - 'Float_t' 0 9999 theta f - 'Float_t' 0 9999 phi",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("DrawViewGL",956,G__AMSDisplay_DrawViewGL_6_1,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("DrawViewX3D",1016,G__AMSDisplay_DrawViewX3D_7_1,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ExecuteEvent",1237,G__AMSDisplay_ExecuteEvent_8_1,121,-1,-1,0,3,1,1,0,
"i - 'Int_t' 0 - event i - 'Int_t' 0 - px "
"i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("GetEvent",802,G__AMSDisplay_GetEvent_9_1,121,-1,-1,0,1,1,1,0,"i - 'Int_t' 0 - event","*MENU*",(void*)NULL,1);
   G__memfunc_setup("Pad",277,G__AMSDisplay_Pad_0_2,85,G__get_linked_tagnum(&G__AMSCintLN_TPad),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetCanvas",892,G__AMSDisplay_GetCanvas_1_2,85,G__get_linked_tagnum(&G__AMSCintLN_AMSCanvas),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetObjInfoPad",1244,G__AMSDisplay_GetObjInfoPad_2_2,85,G__get_linked_tagnum(&G__AMSCintLN_TPad),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetEventInfoPad",1475,G__AMSDisplay_GetEventInfoPad_3_2,85,G__get_linked_tagnum(&G__AMSCintLN_TPad),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetTitlePad",1079,G__AMSDisplay_GetTitlePad_4_2,85,G__get_linked_tagnum(&G__AMSCintLN_TPad),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetColorManager",1498,G__AMSDisplay_GetColorManager_5_2,85,G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
...
"i - 'Int_t' 0 5 range",(char*)NULL,(void*)NULL,0);
...
"i - 'Int_t' 0 - px i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("Paint",508,G__AMS3DCluster_Paint_8_0,121,-1,-1,0,1,1,1,0,"C - 'Option_t' 0 - option",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("PaintShape",1005,G__AMS3DCluster_PaintShape_9_0,121,-1,-1,0,1,1,1,0,"U '_x3d_data_' 'X3DBuffer' 0 - buff",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("DistancetoPrimitive",1991,G__AMS3DCluster_DistancetoPrimitive_0_1,105,-1,G__defined_typename("Int_t"),0,2,1,1,0,
"i - 'Int_t' 0 - px i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("SetPoints",937,G__AMS3DCluster_SetPoints_1_1,121,-1,-1,0,1,1,1,0,"F - 'Float_t' 0 - buff",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("SetPosition",1153,G__AMS3DCluster_SetPosition_2_1,121,-1,-1,0,3,1,1,0,
"f - 'Float_t' 0 - x f - 'Float_t' 0 - y "
"f - 'Float_t' 0 - z",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("SetSize",711,G__AMS3DCluster_SetSize_3_1,121,-1,-1,0,3,1,1,0,
"f - 'Float_t' 0 - dx f - 'Float_t' 0 - dy "
"f - 'Float_t' 0 - dz",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("SetDirection",1229,G__AMS3DCluster_SetDirection_4_1,121,-1,-1,0,2,1,1,0,
"f - 'Float_t' 0 - theta f - 'Float_t' 0 - phi",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Sizeof3D",743,G__AMS3DCluster_Sizeof3D_5_1,121,-1,-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__AMS3DCluster_DeclFileName_6_1,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__AMS3DCluster_DeclFileLine_7_1,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__AMS3DCluster_ImplFileName_8_1,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__AMS3DCluster_ImplFileLine_9_1,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__AMS3DCluster_Class_Version_0_2,115,-1,G__defined_typename("Version_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__AMS3DCluster_Class_1_2,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__AMS3DCluster_Dictionary_2_2,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__AMS3DCluster_IsA_3_2,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__AMS3DCluster_ShowMembers_4_2,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__AMS3DCluster_Streamer_5_2,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   // automatic copy constructor
   G__memfunc_setup("AMS3DCluster",1082,G__AMS3DCluster_AMS3DCluster_6_2,(int)('i'),G__get_linked_tagnum(&G__AMSCintLN_AMS3DCluster),-1,0,1,1,1,0,"u 'AMS3DCluster' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~AMS3DCluster",1208,G__AMS3DCluster_wAAMS3DCluster_7_2,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__tag_memfunc_reset();
}
...
"i - 'Int_t' 0 - px i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,3);
   ...
   G__memfunc_setup("DrawView",809,G__AMSVirtualDisplay_DrawView_0_1,121,-1,-1,0,2,1,1,8,
...
"i - 'Int_t' 0 - py U 'TObject' - 0 - selected",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("AMSCanvas",829,G__AMSCanvas_AMSCanvas_1_0,105,G__get_linked_tagnum(&G__AMSCintLN_AMSCanvas),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("AMSCanvas",829,G__AMSCanvas_AMSCanvas_2_0,105,G__get_linked_tagnum(&G__AMSCintLN_AMSCanvas),-1,0,4,1,1,0,
"C - 'Text_t' 0 - name C - 'Text_t' 0 \"The AMS Display with Root\" title "
"i - 'Int_t' 0 700 ww i - 'Int_t' 0 550 wh",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Update",611,G__AMSCanvas_Update_4_0,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("EditorBar",892,G__AMSCanvas_EditorBar_5_0,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("HandleInput",1116,G__AMSCanvas_HandleInput_6_0,121,-1,-1,0,3,1,1,0,
"i - 'Int_t' 0 - event i - 'Int_t' 0 - px "
"i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("SaveCB",532,G__AMSCanvas_SaveCB_7_0,121,-1,-1,0,3,1,1,0,
"U '_WidgetRec' 'Widget' 0 - - Y - 'XtPointer' 0 - - "
"Y - 'XtPointer' 0 - -",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__AMSCanvas_DeclFileName_8_0,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__AMSCanvas_DeclFileLine_9_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__AMSCanvas_ImplFileName_0_1,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__AMSCanvas_ImplFileLine_1_1,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__AMSCanvas_Class_Version_2_1,115,-1,G__defined_typename("Version_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__AMSCanvas_Class_3_1,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__AMSCanvas_Dictionary_4_1,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__AMSCanvas_IsA_5_1,85,G__get_linked_tagnum(&G__AMSCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__AMSCanvas_ShowMembers_6_1,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__AMSCanvas_Streamer_7_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   // automatic copy constructor
   G__memfunc_setup("AMSCanvas",829,G__AMSCanvas_AMSCanvas_8_1,(int)('i'),G__get_linked_tagnum(&G__AMSCintLN_AMSCanvas),-1,0,1,1,1,0,"u 'AMSCanvas' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~AMSCanvas",955,G__AMSCanvas_wAAMSCanvas_9_1,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__AMSCintLN_AMSColorManager = { "AMSColorManager" , 99 , -1 };
...
extern "C" void G__cpp_setup_tagtableAMSCint() {
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__AMSCintLN_AMSColorManager),sizeof(AMSColorManager),-1,0,"helper class to browse AMSRoot Makers histograms",G__setup_memvarAMSColorManager,G__setup_memfuncAMSColorManager);
...
//
// File generated by rootcint at Tue Dec 16 15:21:38 1997.
...
void THelix::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b << fVz;
      R__b << fW;
      R__b.WriteArray(fAxis, 3);
      R__b << fRotMat;
      R__b.WriteArray(fRange, 2);
   }
}
...
//______________________________________________________________________________
TBuffer &operator>>(TBuffer &buf, AMSColorManager *&obj)
{
   // Read a pointer to an object of class AMSColorManager.

   obj = (AMSColorManager *) buf.ReadObject(AMSColorManager::Class());
   return buf;
}

//______________________________________________________________________________
void AMSColorManager::Streamer(TBuffer &R__b)
{
   // Stream an object of class AMSColorManager.

   TNamed::Streamer(R__b);
}

//______________________________________________________________________________
void AMSColorManager::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
   // Inspect the data members of an object of class AMSColorManager.

   TClass *R__cl  = AMSColorManager::IsA();
   Int_t   R__ncp = strlen(R__parent);
   R__insp.Inspect(R__cl, R__parent, "red[256]", red);
   R__insp.Inspect(R__cl, R__parent, "green[256]", green);
   R__insp.Inspect(R__cl, R__parent, "blue[256]", blue);
...
void AMSDisplay::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
   ...
   R__insp.Inspect(R__cl, R__parent, "*m_ColorManager", &m_ColorManager);
...
void AMSToFClusterReader::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSToFClusterReader::IsA());
      AMSMaker::Streamer(R__b);
      R__b << m_Nclusters;
   }
}
...
void AMSTrackReader::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSTrackReader::IsA());
      AMSMaker::Streamer(R__b);
      R__b << m_NTracks;
      R__b << (TObject*)m_Mult;
   }
...
void AMSSiHitReader::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSSiHitReader::IsA());
      AMSMaker::Streamer(R__b);
      R__b << m_Nclusters;
      R__b << DrawUsedHitsOnly;
   }
...
void AMSCTCClusterReader::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSCTCClusterReader::IsA());
      AMSMaker::Streamer(R__b);
      R__b << m_Nclusters;
   }
}
...
void AMSParticleReader::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSParticleReader::IsA());
      AMSMaker::Streamer(R__b);
      R__b << m_NParticles;
      R__b << (TObject*)m_Mult;
   }
...
void AMSToFCluster::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSToFCluster::IsA());
      AMS3DCluster::Streamer(R__b);
      R__b << m_Status;
      R__b << m_Plane;
      R__b << m_Bar;
...
void AMSTrack::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSTrack::IsA());
      THelix::Streamer(R__b);
      R__b << m_ID;
      R__b << m_Status;
      R__b << m_Pattern;
...
void AMSSiHit::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSSiHit::IsA());
      AMS3DCluster::Streamer(R__b);
      R__b << m_Status;
      R__b << m_Plane;
      R__b << m_X;
...
void AMSCTCCluster::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSCTCCluster::IsA());
      AMS3DCluster::Streamer(R__b);
      R__b << m_Status;
      R__b << m_Plane;
      R__b << m_RawSignal;
...
void AMSParticle::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.WriteVersion(AMSParticle::IsA());
      THelix::Streamer(R__b);
