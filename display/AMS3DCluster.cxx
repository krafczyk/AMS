//  $Id: AMS3DCluster.cxx,v 1.3 2001/01/22 17:32:31 choutko Exp $
...
ClassImp(AMS3DCluster)


//_____________________________________________________________________________
AMS3DCluster::AMS3DCluster()
...
//_____________________________________________________________________________
AMS3DCluster::AMS3DCluster(Float_t x, Float_t y, Float_t z,
...
//_____________________________________________________________________________
AMS3DCluster::AMS3DCluster(Float_t * xyz, Float_t * dxyz, Float_t * cos, 
			   Int_t range) 
#if defined(ROOT10308)
			//v1.03/08
...
// if (display->AllViews()) lwidth /= 2;
   ...
   debugger.Print("AMS3DCluster at (%lf,%lf,%lf)+-(%lf,%lf,%lf) in (%lf,%lf) direction\n", 
...
//______________________________________________________________________________
 const Float_t * AMS3DCluster::GetPosition()
{
//*-*-*-*-*-*-*-*-*-*-*set position (x, y, z)*-*-*-*-*-*-*-*-*-*-*
//*-*                  ======================
...
//______________________________________________________________________________
 const Float_t * AMS3DCluster::GetSize()
{
//*-*-*-*-*-*-*-*-*-*-*set position (x, y, z)*-*-*-*-*-*-*-*-*-*-*
//*-*                  ======================
   static Float_t xyz[3];
...
//______________________________________________________________________________
void AMS3DCluster::SetPosition(Float_t x, Float_t y, Float_t z)
{
//*-*-*-*-*-*-*-*-*-*-*set position (x, y, z)*-*-*-*-*-*-*-*-*-*-*
//*-*                  ======================
...
//______________________________________________________________________________
void AMS3DCluster::SetDirection(Float_t theta, Float_t phi)
{
...
//______________________________________________________________________________
char * AMS3DCluster::GetObjectInfo(Int_t px, Int_t py)
{
...
//*-*                  ============================
  ...
  sprintf(info, 
     "AMS3DCluster at (%f,%f,%f)+-(%f,%f,%f) in (%f,%f) direction", 
	fX, fY, fZ, fDx, fDy, fDz,
#if defined(ROOT10308)
	fTheta, fPhi);
#else
...
//______________________________________________________________________________
void AMS3DCluster::SetPoints(Float_t *buff)
{
...
//______________________________________________________________________________
Int_t AMS3DCluster::DistancetoPrimitive(Int_t px, Int_t py)
{
...
//______________________________________________________________________________
 void AMS3DCluster::PaintShape(X3DBuffer *buff)
{
