//  $Id: AMSMaker.h,v 1.2 2001/01/22 17:32:37 choutko Exp $
#ifndef AMSMaker_H
#define AMSMaker_H
...
public:
   Bool_t         DrawFruits;	 //Draw fruits?
                  ...
                  AMSMaker();
                  AMSMaker(const char *name, const char *title);
   virtual       ~AMSMaker();
   ...
   ClassDef(AMSMaker, 1)   //AMS virtual base class for Makers
};
