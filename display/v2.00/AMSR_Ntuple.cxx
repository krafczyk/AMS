...
//   SetTreeAddress();
   ...
   m_Tree->Branch("probtof",  m_BlkCharge->probtof, "probtof[ncharge][10]/F");
   m_Tree->Branch("probtracker",  m_BlkCharge->probtracker, "probtracker[ncharge][10]/F");
   ...
   m_Tree->Branch("pctcp",  m_BlkParticle->pctcp, "pctcp[npart][2]/I");
   ...
   m_Tree->Branch("signalctc",  m_BlkParticle->signalctc, "signalctc[npart][2]/F");
   m_Tree->Branch("betactc",  m_BlkParticle->betactc, "betactc[npart][2]/F");
   m_Tree->Branch("errorbetactc",  m_BlkParticle->errorbetactc, "errorbetactc[npart][2]/F");
   m_Tree->Branch("cooctc",  m_BlkParticle->cooctc, "cooctc[npart][2][3]/F");
   ...
   m_Tree->Branch("Ctcstatus",  m_BlkCtcclust->Ctcstatus, "Ctcstatus[nctccl]/I");
   m_Tree->Branch("Ctclayer",  m_BlkCtcclust->Ctclayer, "Ctclayer[nctccl]/i");
   m_Tree->Branch("ctccoo",  m_BlkCtcclust->ctccoo, "ctccoo[nctccl][3]/F");
   m_Tree->Branch("ctcercoo",  m_BlkCtcclust->ctcercoo, "ctcercoo[nctccl][3]/F");
   m_Tree->Branch("ctcrawsignal",  m_BlkCtcclust->ctcrawsignal, "ctcrawsignal[nctccl]/F");
   m_Tree->Branch("ctcsignal",  m_BlkCtcclust->ctcsignal, "ctcsignal[nctccl]/F");
   m_Tree->Branch("ctcesignal",  m_BlkCtcclust->ctcesignal, "ctcesignal[nctccl]/F");
   m_Tree->Branch("nctcclmc", &m_BlkCtcmcclu->nctcclmc, "nctcclmc/I");
   m_Tree->Branch("Ctcmcidsoft",  m_BlkCtcmcclu->Ctcmcidsoft, "Ctcmcidsoft[nctcclmc]/I");
   m_Tree->Branch("Ctcmcxcoo",  m_BlkCtcmcclu->Ctcmcxcoo, "Ctcmcxcoo[nctcclmc][3]/F");
   m_Tree->Branch("Ctcmcxdir",  m_BlkCtcmcclu->Ctcmcxdir, "Ctcmcxdir[nctcclmc][3]/F");
   m_Tree->Branch("Ctcstep",  m_BlkCtcmcclu->Ctcstep, "Ctcstep[nctcclmc]/F");
   m_Tree->Branch("ctccharge",  m_BlkCtcmcclu->ctccharge, "ctccharge[nctcclmc]/F");
   m_Tree->Branch("ctcbeta",  m_BlkCtcmcclu->ctcbeta, "ctcbeta[nctcclmc]/F");
   m_Tree->Branch("ctcedep",  m_BlkCtcmcclu->ctcedep, "ctcedep[nctcclmc]/F");
   ...
   m_Tree->Branch("Ctchitstatus",  m_BlkCtchit->Ctchitstatus, "Ctchitstatus[nctcht]/I");
   m_Tree->Branch("Ctchitlayer",  m_BlkCtchit->Ctchitlayer, "Ctchitlayer[nctcht]/i");
   m_Tree->Branch("ctchitcolumn",  m_BlkCtchit->ctchitcolumn, "ctchitcolumn[nctcht]/i");
   m_Tree->Branch("ctchitrow",  m_BlkCtchit->ctchitrow, "ctchitrow[nctcht]/i");
   m_Tree->Branch("ctchitsignal",  m_BlkCtchit->ctchitsignal, "ctchitsignal[nctcht]/F");
