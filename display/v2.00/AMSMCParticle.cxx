//  $Id: AMSMCParticle.cxx,v 1.2 2001/01/22 17:32:37 choutko Exp $
#include <iostream.h>
//////////////////////////////////////////////////////////////////////////
//                                                                      //
...
ClassImp(AMSMCParticle)


/*
//_____________________________________________________________________________
AMSMCParticle::AMSMCParticle(Int_t status, Int_t pattern)
{
   m_Status     = status;
   m_Pattern    = pattern;
}
...
//_____________________________________________________________________________
void AMSMCParticle::Paint(Option_t *option)
{
   ...
   Int_t   n = this->GetN();
   Float_t * p = this->GetP();
   //debugger.Print("::::: AMSMCParticle::Paint() called: color = %d, width = %d.\n", c, w);
...
//_____________________________________________________________________________
char * AMSMCParticle::GetObjectInfo(Int_t px, Int_t py)
{
