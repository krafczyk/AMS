//  $Id: AMSColorManager.cxx,v 1.2 2001/01/22 17:32:31 choutko Exp $
...
ClassImp(AMSColorManager)



//_____________________________________________________________________________
AMSColorManager::AMSColorManager(char * name, char * title) 
                : TNamed(name, title)
{
  //
...
//_____________________________________________________________________________
Int_t AMSColorManager::GetColorAt(Int_t i, Float_t *r, Float_t *g, Float_t *b)
{
  //
...
//_____________________________________________________________________________
Bool_t AMSColorManager::IsValid(Int_t i)
{
  //
...
//_____________________________________________________________________________
Int_t AMSColorManager::Migrate(Int_t i, Int_t j)
{
  //
...
//_____________________________________________________________________________
void AMSColorManager::ColorTest(Int_t begin, Int_t end)
{
