//  $Id: AMSTrack.h,v 1.2 2001/01/22 17:32:32 choutko Exp $
#ifndef AMSTrack_H
#define AMSTrack_H
...
class AMSTrack : public THelix {
//class AMSTrack : public TObject {
...
public:
                  AMSTrack() {;}
                  AMSTrack(Int_t status, Int_t pattern);
   virtual       ~AMSTrack() {;}
   ...
   // Getters and Setters...
   //
   friend class AMSTrackReader;

   ClassDef(AMSTrack, 1)   //AMSRoot track class
};
