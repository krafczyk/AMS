...
protected:
	...
	static Int_t minNSeg;	//minimal number of segments in polyline
...
public:
        ...
        THelix(Double_t x,  Double_t y,  Double_t z, 
               ...
               Double_t w, 
	       Double_t r1=0, Double_t r2=1, EHelixRangeType rtype=kHelixZ,
...
//      virtual void    GetPolyLine(Int_t n, Float_t *p, const Option_t *option) { TPolyLine3D::GetPolyLine(n, p, option); }
...
//      virtual void    PaintPolyLine(Int_t n, Float_t *p, Option_t *option="");
        ...
        virtual void    SetRange(Double_t r1, Double_t r2, EHelixRangeType rtype=kHelixZ);
	        void    SetHelix(Double_t x,  Double_t y,  Double_t z,
			         Double_t vx, Double_t vy, Double_t vz,
			         Double_t w,  
			         Double_t r1=0, Double_t r2=0, EHelixRangeType type=kUnchanged,
			         Double_t hx=0, Double_t hy=0, Double_t hz=1);
