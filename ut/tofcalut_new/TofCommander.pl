...
@AMSHostsList=qw(Any scamsfs1 pcamsr0 pcamsr1 pcamsf3 pcamss0 );
@AMSQueuesList=qw(8nm 1nh 8nh 1nd 1nw 2nw);
@CalibrGapList=qw(0 0.37 1.5 6 8 12 22);
#
@cfilenames=qw(TofCflist2RD TofCStat2RD TofTdelv2RD TofTzeroRD TofAmplf2RD TofElospRD TofTdcorRD); 
#
$prog2run="";
$outlogf="out.log";
...
sub StartSess{
  ...
  if($CalType eq "PedCal"){
    $SessName="PEDC";
    $workdir=$USERTD."/headquarters_new";
