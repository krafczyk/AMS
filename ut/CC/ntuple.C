...
AMSNtuple::AMSNtuple(integer lun, char* name) : AMSNode(AMSID(name,0)) {
  ...
  HBNAME(_lun,"Charge",&_charge.Ncharge,
    "ncharge[0,10],chargestatus(ncharge):I,chargebetap(ncharge):I,chargetof(ncharge):I,chargetracker(ncharge):I,probtof(10,ncharge),probtracker(10,ncharge),truntof(ncharge),truntracker(ncharge)");
