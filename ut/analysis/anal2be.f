...
*
      ...
      if(init.eq.0)then
         ...
         call hbook1(12,'TOFclusters',20,-0.5,19.5,0.)
         call hbook1(21,'Tof 1',100,0.,1.,0.)
         call hbook1(22,'Tof 2',100,0.,1.,0.)
         call hbook1(23,'Tof 3',100,0.,1.,0.)
         call hbook1(24,'Tof 4',100,0.,1.,0.)
         call hbook1(25,'Tof 4',100,0.,1.,0.)
         call hbook1(31,'Tof 1',100,0.,1.,0.)
         call hbook1(32,'Tof 2',100,0.,1.,0.)
         call hbook1(33,'Tof 3',100,0.,1.,0.)
         call hbook1(34,'Tof 4',100,0.,1.,0.)
         call hbook1(35,'Tof 4',100,0.,1.,0.)
         call hbook1(41,'Tof 1',200,0.,2.,0.)
         call hbook1(142,'Tof 2*beta^2',200,0.,.2,0.)
         call hbook1(42,'Tof 2',200,0.,2.,0.)
         call hbook1(43,'Tof 3',200,0.,2.,0.)
         call hbook1(44,'Tof 4',200,0.,2.,0.)
         call hbook1(45,'Tof 4',200,0.,2.,0.)
         call hbook2(101,'Tof2 vs Tof3',100,0.,1.,100,0.,1.,0.)
         call hbook2(102,'Tof2 vs Tof3',100,0.,1.,100,0.,1.,0.)
         call hbook2(103,'Tof2 vs Tof3',100,0.,1.,100,0.,1.,0.)
         call hbook1(51,'beta',200,0.05,1.05,0.)
         call hbook1(52,'beta',200,0.05,1.05,0.)
         call hbook1(152,'beta',200,0.05,1.05,0.)
         call hbook1(252,'beta',200,0.05,1.05,0.)
         call hbook1(54,'beta',200,0.05,2.05,0.)
         call hbook1(154,'beta',200,0.8,1.2,0.)
         call hbook2(53,'beta',100,0.05,0.55,100,0.05,0.55,0.)
         call hbook2(153,'beta',100,0.05,0.55,100,0.05,0.55,0.)
         call hbook1(61,'mass',200,5.,15.,0.)
         call hbook1(62,'mass',200,5.,15.,0.)
         call hbook1(63,'mass',200,5.,15.,0.)
         call hbook1(162,'mass',200,5.,15.,0.)
         call hbook1(262,'mass',200,5.,15.,0.)
         call hbook1(163,'mass',200,5.,15.,0.)
         call hbook1(263,'mass',200,5.,15.,0.)
         call hbook1(64,'mass',200,5.,15.,0.)
         call hbook1(65,'mmom',200,0.,2.,0.)
         call hbook1(71,'Tr 1',200,0.,.1,0.)
         call hbook1(72,'Tr 2',200,0.,.1,0.)
         call hbook1(73,'Tr 3',200,0.,.1,0.)
         call hbook1(74,'Tr 4',200,0.,.1,0.)
         call hbook1(75,'Tr s',200,0.,.1,0.)
         call hbook1(76,'Tr s',200,0.,0.1,0.)
         call hbook1(79,'Tr s',200,0.,0.3,0.)
         call hbook1(81,'betachi2',100,0.,10.,0.)
         call hbook1(1011,'Trclusters',200,-0.5,199.5,0.)
         call hbook1(1012,'TOFclusters',10,-0.5,19.5,0.)
         call hbook1(1021,'Tof 1',100,0.,1.,0.)
         call hbook1(1022,'Tof 2',100,0.,1.,0.)
         call hbook1(1023,'Tof 3',100,0.,1.,0.)
         call hbook1(1024,'Tof 4',100,0.,1.,0.)
         call hbook1(1025,'Tof 4',100,0.,1.,0.)
        init=1
      endif
      ipass=ipass+1
      if(mod(ipass,npass).ne.0)return      
      do i=1,10
         cuts(i)=.false.
      enddo
      s1=0
      ...
      call hf1(12,float(ntof),1.)
      call hf1(21,s1,1.)
      call hf1(22,s2,1.)
      call hf1(23,s3,1.)
      call hf1(24,s4,1.)
      call hf1(25,s1+s2+s3+s4,1.)
      if(npart.gt.0)then
       call hf1(1012,float(ntof),1.)
       call hf1(1021,s1,1.)
       call hf1(1022,s2,1.)
       call hf1(1023,s3,1.)
       call hf1(1024,s4,1.)
       call hf1(1025,s1+s2+s3+s4,1.)
      endif
      anal2be=0
      cuts(1)=s4.lt.0.02.or.s4.gt.0.3
      if(cuts(1))then
       call hf1(31,s1,1.)
       call hf1(32,s2,1.)
       call hf1(33,s3,1.)
       call hf1(34,s4,1.)
       call hf1(35,s1+s2+s3+s4,1.)
        rd=(x(2)-x(1))**2+(y(2)-y(1))**2+(z(2)-z(1))**2
        rd=sqrt(rd)
       cuts(2)=s1+s2+s3.gt.0.6.and.s3.gt.0.25
       if(cuts(2))then
...
c        write (*,*)'ok 2'
        ...
        if(s4.lt.0.02.and.npart.eq.0)then
         call hf2(101,s2,s3,1.)
         call hf2(103,s2,s3,1.)
        endif
        call hf1(41,s1,1.)
        call hf1(42,s2,1.)
        call hf1(43,s3,1.)
        call hf1(44,s4,1.)
        call hf1(45,s1+s2+s3+s4,1.)
        b2=sqrt(0.028/s2/ct)
        if(b2.lt.0.65)then
          delta2=(1.-b2**2)/b2**2
         gamma2=delta2*(1+sqrt((delta2-1.)/delta2))
         call hf1(163,(s3)*gamma2,1.)
         call hf1(162,(s3+s4)*gamma2,1.)
        endif
c        write (*,*)'ok 2a'
...
c          write(*,*)'1',s1,s2,s3,s4,b3
         ...
         call hf1(263,(s3+0.018)*gamma3,1.)
         call hf1(262,(s3+s4+0.018)*gamma3,1.)
        endif
c        write (*,*)'ok 3'
        call hf1(52,b2,1.)
        call hf1(152,b3,1.)
     ...
     +      abs(hitr(3,phits(j,ipt))-z(1))/abs(z(2)-z(1))
           ...
           ipb=pbetap(npart)
c           ipb=1
           call hf1(51,beta(ipb),1.)
c           write (*,*)'ok 4'
           
           call hf2(53,beta(ipb),b2,1.)
           call hf2(153,beta(ipb),b3,1.)
           call hf1(54,b2/beta(ipb),1.)
           call hf1(154,b3/beta(ipb),1.)
           if(s4.lt.0.02)then
            call hf1(142,s2*beta(ipb)**2*ct,1.)
            call hf2(102,s2,s3+s/2.,1.)
            call hf2(103,s2,s3+s/2.,1.)
           endif
           cuts(4)=beta(ipb).lt.0.5
           if(cuts(4))then
            call hf1(81,betachi2(1),1.)
            xm0=9.328
...
c     +      beta(1),betachi2(1)
            ...
            call hf1(61,(s3)*gamma,1.)
            call hf1(62,(s4+s3+s/2)*gamma,1.)
            call hf1(63,(s3+s/2.)*gamma,
1.)
            call hf1(262,(s4+s3+s/2)*gamma,1.)
            call hf1(263,(s3+s/2.)*gamma,1.)
            call hf1(163,(s3+s/2.)*gamma2,1.)
            call hf1(64,pmass(npart),1.)
            call hf1(65,pmom(npart)/momentum(1),1.)
          endif
         endif
       endif 
      endif
