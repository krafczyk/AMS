...
//
    if(TGL1FFKEY.printfl>0)HF1(1098,0.,1.);
    for(i=0;i<8;i++){
      if(BranchOK[i]){
        if(TGL1FFKEY.printfl>0)HF1(1098,geant(i+1),1.);//fired
      }
...
//---
  if(TGL1FFKEY.printfl>12 || SetupIsChanged){//print setup info (if requested or changed during the job-running):
    if(SetupIsChanged){
      cout<<"===================================================="<<endl;
