...
void AMSJob::_sictcdata(){
  ...
  CTCGEOMFFKEY.supzc=-102.7;    // supp. honeycomb plate front face Z-pos
  ...
  CTCGEOMFFKEY.thcsize[0]=140.; //
  CTCGEOMFFKEY.thcsize[1]=140.; // Support structure dimensions (cm)
  CTCGEOMFFKEY.thcsize[2]=10.;  //
  CTCGEOMFFKEY.upper[0]=116.2;  //
  CTCGEOMFFKEY.upper[1]=92.2;   // Upper/Lower layer dimensions (cm)
  CTCGEOMFFKEY.upper[2]=17.70;  //
