// $Id: job.C,v 1.870.4.4 2012/09/26 13:32:18 mdelgado Exp $
...
void AMSJob::_timeinitjob(){
...

  {
    ...
    if(isRealData()){
      ...
      DynAlManager::tdvdb=new AMSTimeID(AMSID("DynAlignmentV5T120628",1),begin,end,sizeof(DynAlManager::tdvBuffer),&DynAlManager::tdvBuffer,server,DynAlManager::need2bookTDV,_ToAlign);
