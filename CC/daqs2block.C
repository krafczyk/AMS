...
#ifdef __AMSDEBUG__
	    if(tdcbfo[slid-1]==0)cout<<"DAQS2Block::RawFmt_Error:SWCH_Buf_Ovfl, hwid/swid="<<hwid<<" "<<swid<<endl;
	    tdcbfo[slid-1]=1;
#endif
...
//      bad=true;
      ...
      cout<<"<--------- buildOnbP:Error: Some sides are doubled, NrequestedSDRs="<<_NReqEdrs<<endl;
      goto Exit;
    }
