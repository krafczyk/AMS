...
void AMSJob::_retof2onlineinitjob(){
...
//   For each side:
  ...
  cout<<"...AMS02-TOF monitoring selected"<<endl;
...
//-----------------------------------------------------
void TOF2RawEvent::tofonlinefill1(integer ilay, integer ibar, integer isid,
...
//       dir = 1 if (isid==2 && ilay==1||4) || (isid==1 && ilay==2||3)
  ...
  // Time Expansion
  TOF2Brcal::scbrcal[ilay-1][ibar-1].gtstrat(strat);
