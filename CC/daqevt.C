//  $Id: daqevt.C,v 1.222.2.5 2011/07/19 10:50:36 choutko Exp $
#ifdef __CORBA__
#include <producer.h>
#endif
#include <stdio.h>
	...
	if(ftxt){
	  ...
	  againscp:
		...
		setenv("LD_LIBRARY_PATH",getenv("TransferSharedLib"),1);
	      ...
	      string cp((getenv("TransferRawBy2") &&!strstr(getenv("TransferRawBy2"),":"))?getenv("TransferRawBy2"):"scp ");
