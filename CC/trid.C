...
if(setup==1){
  ...
  for(s=0;s<_ncrates;s++)_CrateNo[s]=s;
       ...
       _GetHard[0][0][0][2]=1; //crate 
       _GetHard[0][0][0][0]=11; //side x 
       _GetHard[0][0][0][1]=11; //side y 
       _GetHard[0][0][1][2]=0; //crate 
       _GetHard[0][0][1][0]=1; //side x 
       _GetHard[0][0][1][1]=1; //side y 
       _GetHard[0][1][0][2]=1; //crate 
       _GetHard[0][1][0][0]=6; //side x 
       _GetHard[0][1][0][1]=6; //side y 
       _GetHard[0][1][1][2]=0; //crate 
       _GetHard[0][1][1][0]=4; //side x 
       _GetHard[0][1][1][1]=4; //side y 
       _GetHard[0][2][0][2]=1; //crate 
       _GetHard[0][2][0][0]=10; //side x 
       _GetHard[0][2][0][1]=10; //side y 
       _GetHard[0][2][1][2]=0; //crate 
       _GetHard[0][2][1][0]=0; //side x 
       _GetHard[0][2][1][1]=0; //side y 
       _GetHard[0][3][0][2]=1; //crate 
       _GetHard[0][3][0][0]=13; //side x 
       _GetHard[0][3][0][1]=13; //side y 
       _GetHard[0][3][1][2]=0; //crate 
       _GetHard[0][3][1][0]=13; //side x 
       _GetHard[0][3][1][1]=13; //side y 
       _GetHard[0][4][0][2]=1; //crate 
       _GetHard[0][4][0][0]=16; //side x 
       _GetHard[0][4][0][1]=16; //side y 
       _GetHard[0][4][1][2]=0; //crate 
       _GetHard[0][4][1][0]=16; //side x 
       _GetHard[0][4][1][1]=16; //side y 
       _GetHard[0][5][0][2]=1; //crate 
       _GetHard[0][5][0][0]=12; //side x 
       _GetHard[0][5][0][1]=12; //side y 
       _GetHard[0][5][1][2]=0; //crate 
       _GetHard[0][5][1][0]=12; //side x 
       _GetHard[0][5][1][1]=12; //side y 
       _GetHard[0][6][0][2]=2; //crate 
       _GetHard[0][6][0][0]=10; //side x 
       _GetHard[0][6][0][1]=10; //side y 
       ...
       _GetHard[0][8][0][0]=11; //side x 
       _GetHard[0][8][0][1]=11; //side y 
...
*/
       ...
       _GetHard[0][9][1][2]=3; //crate 
       _GetHard[0][9][1][0]=12; //side x 
       _GetHard[0][9][1][1]=12; //side y 
       _GetHard[0][10][0][2]=2; //crate 
       _GetHard[0][10][0][0]=16; //side x 
       _GetHard[0][10][0][1]=16; //side y 
       _GetHard[0][10][1][2]=3; //crate 
       _GetHard[0][10][1][0]=16; //side x 
       _GetHard[0][10][1][1]=16; //side y 
       _GetHard[0][11][0][2]=2; //crate 
       _GetHard[0][11][0][0]=13; //side x 
       _GetHard[0][11][0][1]=13; //side y 
       _GetHard[0][11][1][2]=3; //crate 
       _GetHard[0][11][1][0]=13; //side x 
       _GetHard[0][11][1][1]=13; //side y 
       _GetHard[0][12][0][2]=2; //crate 
       _GetHard[0][12][0][0]=0; //side x 
       _GetHard[0][12][0][1]=0; //side y 
       _GetHard[0][12][1][2]=3; //crate 
       _GetHard[0][12][1][0]=10; //side x 
       _GetHard[0][12][1][1]=10; //side y 
       _GetHard[0][13][0][2]=2; //crate 
       _GetHard[0][13][0][0]=4; //side x 
       _GetHard[0][13][0][1]=4; //side y 
       _GetHard[0][13][1][2]=3; //crate 
       _GetHard[0][13][1][0]=6; //side x 
       _GetHard[0][13][1][1]=6; //side y 
       _GetHard[0][14][0][2]=2; //crate 
       _GetHard[0][14][0][0]=1; //side x 
       _GetHard[0][14][0][1]=1; //side y 
       _GetHard[0][14][1][2]=3; //crate 
       _GetHard[0][14][1][0]=11; //side x 
       _GetHard[0][14][1][1]=11; //side y 
       ...
       _GetHard[2][0][0][2]=1; //crate 
       _GetHard[2][0][0][0]=7; //side x 
       _GetHard[2][0][0][1]=7; //side y 
       _GetHard[2][1][0][2]=1; //crate 
       _GetHard[2][1][0][0]=19; //side x 
       _GetHard[2][1][0][1]=19; //side y 
       _GetHard[2][1][1][2]=0; //crate 
       _GetHard[2][1][1][0]=5; //side x 
       _GetHard[2][1][1][1]=5; //side y 
       _GetHard[2][2][0][2]=1; //crate 
       _GetHard[2][2][0][0]=23; //side x 
       _GetHard[2][2][0][1]=23; //side y 
       _GetHard[2][2][1][2]=0; //crate 
       _GetHard[2][2][1][0]=17; //side x 
       _GetHard[2][2][1][1]=17; //side y 
       _GetHard[2][3][0][2]=1; //crate 
       _GetHard[2][3][0][0]=17; //side x 
       _GetHard[2][3][0][1]=17; //side y 
       _GetHard[2][3][1][2]=0; //crate 
       _GetHard[2][3][1][0]=23; //side x 
       _GetHard[2][3][1][1]=23; //side y 
       _GetHard[2][4][0][2]=1; //crate 
       _GetHard[2][4][0][0]=5; //side x 
       _GetHard[2][4][0][1]=5; //side y 
       _GetHard[2][4][1][2]=0; //crate 
       _GetHard[2][4][1][0]=19; //side x 
       _GetHard[2][4][1][1]=19; //side y 
       _GetHard[2][5][0][2]=1; //crate 
       _GetHard[2][5][0][0]=1; //side x 
       _GetHard[2][5][0][1]=1; //side y 
       _GetHard[2][5][1][2]=0; //crate 
       _GetHard[2][5][1][0]=7; //side x 
       _GetHard[2][5][1][1]=7; //side y 
       _GetHard[2][6][0][2]=2; //crate 
       _GetHard[2][6][0][0]=7; //side x 
       _GetHard[2][6][0][1]=7; //side y 
       _GetHard[2][6][1][2]=3; //crate 
       _GetHard[2][6][1][0]=1; //side x 
       _GetHard[2][6][1][1]=1; //side y 
       _GetHard[2][7][0][2]=2; //crate 
       _GetHard[2][7][0][0]=19; //side x 
       _GetHard[2][7][0][1]=19; //side y 
       _GetHard[2][7][1][2]=3; //crate 
       _GetHard[2][7][1][0]=5; //side x 
       _GetHard[2][7][1][1]=5; //side y 
       _GetHard[2][8][0][2]=2; //crate 
       _GetHard[2][8][0][0]=23; //side x 
       _GetHard[2][8][0][1]=23; //side y 
       _GetHard[2][8][1][2]=3; //crate 
       _GetHard[2][8][1][0]=17; //side x 
       _GetHard[2][8][1][1]=17; //side y 
       _GetHard[2][9][0][2]=2; //crate 
       _GetHard[2][9][0][0]=17; //side x 
       _GetHard[2][9][0][1]=17; //side y 
       _GetHard[2][9][1][2]=3; //crate 
       _GetHard[2][9][1][0]=23; //side x 
       _GetHard[2][9][1][1]=23; //side y 
       _GetHard[2][10][0][2]=2; //crate 
       _GetHard[2][10][0][0]=5; //side x 
       _GetHard[2][10][0][1]=5; //side y 
       _GetHard[2][10][1][2]=3; //crate 
       _GetHard[2][10][1][0]=19; //side x 
       _GetHard[2][10][1][1]=19; //side y 
       _GetHard[2][11][1][2]=3; //crate 
       _GetHard[2][11][1][0]=7; //side x 
       _GetHard[2][11][1][1]=7; //side y 
       ...
       _GetHard[4][0][0][2]=5; //crate 
       _GetHard[4][0][0][0]=21; //side x 
       _GetHard[4][0][0][1]=21; //side y 
       _GetHard[4][0][1][2]=4; //crate 
       _GetHard[4][0][1][0]=3; //side x 
       _GetHard[4][0][1][1]=3; //side y 
       _GetHard[4][1][0][2]=5; //crate 
       _GetHard[4][1][0][0]=16; //side x 
       _GetHard[4][1][0][1]=16; //side y 
       _GetHard[4][1][1][2]=4; //crate 
       _GetHard[4][1][1][0]=15; //side x 
       _GetHard[4][1][1][1]=15; //side y 
       _GetHard[4][2][0][2]=5; //crate 
       _GetHard[4][2][0][0]=15; //side x 
       _GetHard[4][2][0][1]=15; //side y 
       _GetHard[4][2][1][2]=4; //crate 
       _GetHard[4][2][1][0]=16; //side x 
       _GetHard[4][2][1][1]=16; //side y 
       _GetHard[4][3][0][2]=5; //crate 
       _GetHard[4][3][0][0]=3; //side x 
       _GetHard[4][3][0][1]=3; //side y 
       _GetHard[4][3][1][2]=4; //crate 
       _GetHard[4][3][1][0]=21; //side x 
       _GetHard[4][3][1][1]=21; //side y 
       _GetHard[4][4][0][2]=5; //crate 
       _GetHard[4][4][0][0]=6; //side x 
       _GetHard[4][4][0][1]=6; //side y 
       _GetHard[4][4][1][2]=4; //crate 
       _GetHard[4][4][1][0]=9; //side x 
       _GetHard[4][4][1][1]=9; //side y 
       _GetHard[4][5][0][2]=6; //crate 
       _GetHard[4][5][0][0]=9; //side x 
       _GetHard[4][5][0][1]=9; //side y 
       _GetHard[4][5][1][2]=7; //crate 
       _GetHard[4][5][1][0]=6; //side x 
       _GetHard[4][5][1][1]=6; //side y 
       _GetHard[4][6][0][2]=6; //crate 
       _GetHard[4][6][0][0]=21; //side x 
       _GetHard[4][6][0][1]=21; //side y 
       _GetHard[4][6][1][2]=7; //crate 
       _GetHard[4][6][1][0]=3; //side x 
       _GetHard[4][6][1][1]=3; //side y 
       _GetHard[4][7][0][2]=6; //crate 
       _GetHard[4][7][0][0]=16; //side x 
       _GetHard[4][7][0][1]=16; //side y 
       _GetHard[4][7][1][2]=7; //crate 
       _GetHard[4][7][1][0]=15; //side x 
       _GetHard[4][7][1][1]=15; //side y 
       _GetHard[4][8][0][2]=6; //crate 
       _GetHard[4][8][0][0]=15; //side x 
       _GetHard[4][8][0][1]=15; //side y 
       _GetHard[4][8][1][2]=7; //crate 
       _GetHard[4][8][1][0]=16; //side x 
       _GetHard[4][8][1][1]=16; //side y 
       _GetHard[4][9][0][2]=6; //crate 
       _GetHard[4][9][0][0]=3; //side x 
       _GetHard[4][9][0][1]=3; //side y 
       _GetHard[4][9][1][2]=7; //crate 
       _GetHard[4][9][1][0]=21; //side x 
       _GetHard[4][9][1][1]=21; //side y 
       ...
       _GetHard[6][0][0][0]=8; //side x 
       _GetHard[6][0][0][1]=8; //side y 
       _GetHard[6][1][0][2]=5; //crate 
       _GetHard[6][1][0][0]=9; //side x 
       _GetHard[6][1][0][1]=9; //side y 
       _GetHard[6][2][0][2]=5; //crate 
       _GetHard[6][2][0][0]=20; //side x 
       _GetHard[6][2][0][1]=20; //side y 
       _GetHard[6][2][1][2]=4; //crate 
       _GetHard[6][2][1][0]=2; //side x 
       _GetHard[6][2][1][1]=2; //side y 
       _GetHard[6][3][0][2]=5; //crate 
       _GetHard[6][3][0][0]=12; //side x 
       _GetHard[6][3][0][1]=12; //side y 
       _GetHard[6][3][1][2]=4; //crate 
       _GetHard[6][3][1][0]=14; //side x 
       _GetHard[6][3][1][1]=14; //side y 
       _GetHard[6][4][0][2]=5; //crate 
       _GetHard[6][4][0][0]=14; //side x 
       _GetHard[6][4][0][1]=14; //side y 
       _GetHard[6][4][1][2]=4; //crate 
       _GetHard[6][4][1][0]=12; //side x 
       _GetHard[6][4][1][1]=12; //side y 
       _GetHard[6][5][0][2]=5; //crate 
       _GetHard[6][5][0][0]=2; //side x 
       _GetHard[6][5][0][1]=2; //side y 
       _GetHard[6][5][1][2]=4; //crate 
       _GetHard[6][5][1][0]=20; //side x 
       _GetHard[6][5][1][1]=20; //side y 
       _GetHard[6][6][0][2]=5; //crate 
       _GetHard[6][6][0][0]=10; //side x 
       _GetHard[6][6][0][1]=10; //side y 
       _GetHard[6][6][1][2]=4; //crate 
       _GetHard[6][6][1][0]=8; //side x 
       _GetHard[6][6][1][1]=8; //side y 
       _GetHard[6][7][0][2]=6; //crate 
       _GetHard[6][7][0][0]=8; //side x 
       _GetHard[6][7][0][1]=8; //side y 
       _GetHard[6][7][1][2]=7; //crate 
       _GetHard[6][7][1][0]=10; //side x 
       _GetHard[6][7][1][1]=10; //side y 
       _GetHard[6][8][0][2]=6; //crate 
       _GetHard[6][8][0][0]=20; //side x 
       _GetHard[6][8][0][1]=20; //side y 
       _GetHard[6][8][1][2]=7; //crate 
       _GetHard[6][8][1][0]=2; //side x 
       _GetHard[6][8][1][1]=2; //side y 
       _GetHard[6][9][0][2]=6; //crate 
       _GetHard[6][9][0][0]=12; //side x 
       _GetHard[6][9][0][1]=12; //side y 
       _GetHard[6][9][1][2]=7; //crate 
       _GetHard[6][9][1][0]=14; //side x 
       _GetHard[6][9][1][1]=14; //side y 
       _GetHard[6][10][0][2]=6; //crate 
       _GetHard[6][10][0][0]=14; //side x 
       _GetHard[6][10][0][1]=14; //side y 
       _GetHard[6][10][1][2]=7; //crate 
       _GetHard[6][10][1][0]=12; //side x 
       _GetHard[6][10][1][1]=12; //side y 
       _GetHard[6][11][0][2]=6; //crate 
       _GetHard[6][11][0][0]=2; //side x 
       _GetHard[6][11][0][1]=2; //side y 
       _GetHard[6][11][1][2]=7; //crate 
       _GetHard[6][11][1][0]=20; //side x 
       _GetHard[6][11][1][1]=20; //side y 
       _GetHard[6][12][1][2]=7; //crate 
       _GetHard[6][12][1][0]=9; //side x 
       _GetHard[6][12][1][1]=9; //side y 
       _GetHard[6][13][1][2]=7; //crate 
       _GetHard[6][13][1][0]=8; //side x 
       _GetHard[6][13][1][1]=8; //side y 
