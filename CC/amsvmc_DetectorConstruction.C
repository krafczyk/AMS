...
/// \cond CLASSIMP
ClassImp(amsvmc_DetectorConstruction)
/// \endcond

//_____________________________________________________________________________
amsvmc_DetectorConstruction::amsvmc_DetectorConstruction()
  : TObject(),
    fNbOfLayers(0),
    fWorldSizeX(0.),
    fWorldSizeYZ(0.),
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::ComputeCalorParameters()
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::ConstructMaterials()
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::ConstructGeometry()
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetCuts()
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::PrintCalorParameters()
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetNbOfLayers(Int_t value)
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetDefaultMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetAbsorberMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetGapMaterial(const TString& materialName)
{
/// Set gap material
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetCalorSizeYZ(Double_t value)
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetAbsorberThickness(Double_t value)
{
...
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::SetGapThickness(Double_t value)
{
...
/*
//_____________________________________________________________________________
void amsvmc_DetectorConstruction::UpdateGeometry()
{
