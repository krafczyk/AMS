...
void AntiRecoPG::InitCal(int run_type){ 
  ...
  tcal[0][0]=-10.5-(-1.984259e+01)+0.705622+0.1; //par0
  tcal[0][1]=-4.5-(-1.616684e+01)+2.83776+0.2;
  tcal[0][2]=-4.5-(-1.629861e+01)+1.19891-0.2;
  tcal[0][3]=-10.5-(-1.885605e+01)-1.05101-0.3;
  tcal[0][4]=-10.5-(3.077705e+00)+0.581232+0.2;
  tcal[0][5]=-4.5-(6.362599e+00)+2.68788+0.3;
  tcal[0][6]=-4.5-(6.418757e+00)+1.2676-0.2;
  tcal[0][7]=-10.5-(3.750677e+00)-0.818199-0.3;
  }
  else{ // montecarlo
    tsme = 1.; // artificial extra smearing for MC
  tcal[0][0]=-4.18751+0.705622+0.1;
  tcal[0][1]=-0.92829+2.83776+0.2;
  tcal[0][2]=-0.87922+1.19891-0.2;
  tcal[0][3]=-4.19148-1.05101-0.3;
  tcal[0][4]=-4.274815+0.581232+0.2;
  tcal[0][5]=-1.190892+2.68788+0.3;
  tcal[0][6]=-1.152018+1.2676-0.2;
  tcal[0][7]=-4.325756-0.818199-0.3;
  }
