...
public:  
  ...
  /// Version DSP
  int dspver;
  /// low threshold parameter (i.e. the parameter to recover the sigma value)
  float lowthres;
  /// high threshold parameter (i.e. the parameter to recover the sigma value) 
  float highthres;
...
public:
  ...
  static int GetSize() {return (1024*4+6);}
