...
!$OMP THREADPRIVATE (/ENERIN/)
      COMMON /SDFLAG/ ISD
!$OMP THREADPRIVATE (/SDFLAG/)
      COMMON /XDIDID/XDIDI
*
...
*
      IDIFTP = 1.0D0+1.999D0*RNDMDPM(V)
*----------------------- S.Roesler 5/26/93
...
*
   30 CONTINUE
      B33   = 8.0D0
      ES    = -2.0D0/(B33**2)*LOG(RNDMDPM(V)*RNDMDPM(V))
