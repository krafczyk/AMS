...
C                                   pi- + p --> Lam + K0
	  IF(DELLLA.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELLLA)IDELLL=IDELLL+1
	    DELLLA=IDELLL
...
C                                   pi+ + n --> Lam + K+
	  IF(DELLLB.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELLLB)IDELLL=IDELLL+1
	    DELLLB=IDELLL
...
C                                   pi0 + n --> Lam + K0
	  IF(DELLLC.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELLLC)IDELLL=IDELLL+1
	    DELLLC=IDELLL
...
C                                   pi0 + p --> Lam + K+
	  IF(DELLLD.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELLLD)IDELLL=IDELLL+1
	    DELLLD=IDELLL
...
C                          pi+ + pb --> aLam + aK0
	  IF(DELALA.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELALA)IDELAL=IDELAL+1
	    DELALA=IDELAL
...
C                          pi- + nb --> aLam + aK-
	  IF(DELALB.GT.TINY)THEN
	    ...
	    IF(RNDMDPM(V).LE.TELALB)IDELAL=IDELAL+1
	    DELALB=IDELAL
