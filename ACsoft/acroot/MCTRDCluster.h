#ifndef MCTRDCluster_h
#define MCTRDCluster_h

#include "Tools.h"
#include "MCTRDCluster-Streamer.h"
...
public:
  ...
  AC_MCTRDCluster_Variables

  /** Helper method dumping an MCTRDCluster object to the console
    */
  void Dump() const;
...
private:
  REGISTER_CLASS_WITH_TABLE(MCTRDCluster)
};
