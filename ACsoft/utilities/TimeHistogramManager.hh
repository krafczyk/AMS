...
/** Utitlity class for enforcing consistent time binning of histograms.
  ...
  * histograms with the proper time binning by a call to the MakeNewTimeHistogram2D()
  * function.
  *
...
/** Create a new time histogram with correct global time binning.
  *
  ...
  *
  * This function works for all 2-dimensional histograms, for example:
  * \code
